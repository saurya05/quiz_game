...
int main(){
    FILE *file;
	int i,j,q=1,c,w,correct,x,lChoice,n=0;
	...
	while(1){
    	...
    	if(choice=='S'){
            ...
            if(lChoice==1){
                for(i=0;i<10;i++){
                    if(ansL[i]==ans1[i]) ++correct;
                }
            }else if(lChoice==2){
                for(i=0;i<10;i++){
                    if(ansL[i]==ans2[i]) ++correct;
                }
            }else if(lChoice==3){
                for(i=0;i<10;i++){
                    if(ansL[i]==ans3[i]) ++correct;
                }
            }
            file=fopen("Previous score.txt","w");
    	    fprintf(file,"%s %d",name,correct);
    	    fclose(file);
    	    printf("\n\n\n\t\t\t\t**************** CONGRATULATION *****************");
    		...
    		int score;
    		char name1[30];
   			file=fopen("Previous score.txt","r");
   			fscanf(file,"%s %d",&name1,&score);
